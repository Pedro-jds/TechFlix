...
//   $.getJSON(`http://www.omdbapi.com/?`, { s: filmesPesquisados, apikey: 'eef5e1d2', type: 'movie',page:`${page}` }, function (filmesInfo, statusText, xhr) {
//       //verifica e o status da requisição é 200(ok)
...
//             exibirFilme += `<figcaption>${movie.Title}<br>Ano: ${movie.Year}</figcaption>`
//             exibirFilme += `</figure>`
//             $('.img-container').append(exibirFilme)
//           }
//         }
//         )
//       }
